...
const jestConfig =
  ...
  "jest": {
    ...
    "setupFiles": [
      "E:/Repositories/simple-redux-app/src/tests/setup.js"
    ],
    "moduleNameMapper": {
    ...
    "transform": {
      "^.+\\\\.js$": "babel-jest",
      "^.+\\\\.jsx$": "babel-jest",
      "\\\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga)$": "E:/Repositories/simple-redux-app/src/tests/__mock__/fileTransformer.js"
    }
  }`;
